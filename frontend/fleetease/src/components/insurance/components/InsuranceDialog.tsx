...
import type { Insurance, InsuranceCompany, PaymentMethod, InsuranceStatus, InsuranceType } from '../types';
...
export default function InsuranceDialog({ 
  ...
  const [formData, setFormData] = React.useState<Partial<Insurance>>(
    insurance || {
      ...
      insurance_company_id: 0,  // Změněno z null na 0
      company_id: 0,           // Změněno z null na 0
      description: ''
    }
  );
 ...
 const handleCompanyChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
   setFormData({
     ...formData,
     insurance_company_id: parseInt(e.target.value)
   });
 };
      ...
      >
        ...
        <option value="liability">Liability</option>
         ...
         <div className="grid grid-cols-2 gap-4">
           <div>
             ...
             <input
               ...
               onChange={(e) => setFormData({ ...formData, premium_amount: parseFloat(e.target.value) || null })}
               className="w-full p-2 border rounded-md"
               required
             />
           </div>
         ...
         <div>
           ...
           <select
  value={formData.insurance_company_id || 0}  // Změněno z '' na 0
  onChange={handleCompanyChange}
  className="w-full p-2 border rounded-md"
  required
>
  <option value={0}>Select Insurance Company</option>  // Změněno z '' na 0
